...
// use cw721::msg::{InstantiateMsg as Sg721InstantiateMsg, RoyaltyInfoResponse};
...
// pub fn contract_cw721() -> Box<dyn Contract<StargazeMsgWrapper>> {
//     let contract = ContractWrapper::new(
//         cw721::contract::execute,
//         cw721::contract::instantiate,
//         cw721::contract::query,
//     );
//     Box::new(contract)
// }
...
//         cw721_code_id,
//         cw721_instantiate_msg: Sg721InstantiateMsg {
